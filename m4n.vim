" File: afterglow.vim Author: Danilo Augusto <daniloaugusto.ita16@gmail.com>
" Date: 2017-02-27
...
let s:selection = "502025"
let s:line = "393939"
let s:comment = "797979"
let s:red = "ac4142"
let s:orange = "e87d3e"
let s:yellow = "e5b567"
let s:darkyellow = "412d0b"
let s:green = "b4c973"
let s:blue = "6c99bb"
let s:wine = "b05279"
let s:purple = "9e86c8"
...
if has("gui_running") || &t_Co == 88 || &t_Co == 256
    ...
    call <SID>X("pythonOperator", s:wine, "", "")
    call <SID>X("pythonNumber", s:bidonclair, "", "")
    call <SID>X("pythonString", s:yellow, s:darkyellow, "")
    call <SID>X("pythonRawString", s:yellow, "", "")
    call <SID>X("pythonDecorator", s:wine, "", "")
    call <SID>X("pythonDoctest", s:yellow, "", "")
